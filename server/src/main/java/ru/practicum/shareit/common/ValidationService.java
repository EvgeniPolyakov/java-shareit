...
public class ValidationService {
    ...
    private static final String NO_RIGHTS_TO_COMMENT_MESSAGE = "У пользователя %s нет прав комментировать.";
    ...
    public void validateComment(Comment comment, Long userId) {
        ...
        if (!bookingService.isUserPresentAmongBookers(userId)) {
            throw new BadRequestException(String.format(NO_RIGHTS_TO_COMMENT_MESSAGE, userId));
        }
